<?php 
// Caminho: /public_html/modules/multi_pipeline/views/pipelines/kanban_card.php
...
<li data-lead-id="<?php echo e($lead['id']); ?>" 
    ...
    <?php echo e($lead_already_client_tooltip); ?> 
    class="lead-kan-ban<?php 
        if ($lead['assigned'] == get_staff_user_id()) {
    ...
    <div class="panel-body lead-body">
        <div class="tw-flex lead-name">
            ...
            <a href="<?php echo admin_url('profile/'. $lead['assigned']);?>" data-placement="right"
                ...
                'taff-profile-image-xs',
                ]);?></a>
            <?php  }?>
            <a href="<?php echo admin_url('tblmulti_pipeline_leads/index/'. e($lead['id']));?>"
...
<p class="text-muted lead-field-heading"><?php echo _l('lead_zip');?></p>
                ...
                <p class="text-muted lead-field-heading"><?php echo _l('lead_pipeline');?></p>
                <p class="bold tw-text-sm"><?php echo e($pipeline['name'] ?? '-'); ?></p>
            </div>
        </div>
    </div>
</li>
